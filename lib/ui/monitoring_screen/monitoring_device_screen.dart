...
import '../../_old/old_data/old_hive_implements.dart';
import '../../_old/old_ui/old_rename_device.dart';
import '../../riverpod/riverpod.dart';
import '../../static/logger.dart';

class MonitoringDeviceScreen extends ConsumerStatefulWidget {
  final DiscoveredDevice d;
  const MonitoringDeviceScreen({super.key, required this.d});
...
class _MonitoringDeviceScreenState extends ConsumerState<MonitoringDeviceScreen> with SingleTickerProviderStateMixin {
  ...
  DiscoveredDevice get device => widget.d;
  ...
  void initDeviceInfo() async {
    mac = device.id;
    deviceName = device.name.isEmpty ? 'NoName' : device.name;
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text('обновление\nпоказаний', style: darkBlue12, textAlign: TextAlign.center,)
          ],
        )
      ),
    );
  ...
  Widget subtitle(double? value, String unit){
    ...
    TextStyle style = value != null && unit == 'A' ? (value < 0 ? red18 : (value > 0 ? green18 : darkBlue18)) : darkBlue18;
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(child: Text('${data[cellKey].toStringAsFixed(2)} V', style: darkBlue16)),
                ],
              ),
            )
                  ...
                  Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                        top: 10,
                        right: -1,
                        child: Text('${index + 1}', style: darkBlue12,)
                      )
                    ],
                  ),
                  const SizedBox(width: 10),
                  Expanded(child: Text('${data[cellKey]}', style: darkBlue16)),
                ],
              ),
            )
          : const SizedBox.shrink();
  ...
  //   final data = ref.read(bmsDataStreamProvider(deviceID));
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index){
          return ListTile(
            ...
            title: Text('Ошибка: ${errors[index]}', style: darkBlue14,),
          );
        }
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, child){
        ...
        final batteryData = ref.watch(bmsDataStreamProvider(device.id));
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Image.asset('lib/images/stark_label.png', scale: 9.0),
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text('напряжение ячеек', style: darkBlue16,))
                              ),
                            ),
                            const SizedBox(height: 5,),
                            cellsInfo(data),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text('температура', style: darkBlue16,))
                              ),
                            ),
                            const SizedBox(height: 5,),
                            tempInfo(data),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text('опции', style: darkBlue16,))
                              ),
                            ),
                            const SizedBox(height: 5,),
                            options(context),
                            const SizedBox(height: 15),
                            // starkDevices.contains(mac) && flavor == 'stark' ? 
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text('произведено', style: darkBlue14),
                                  ),
                                  const SizedBox(width: 5,),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 0),
                                    child: Text('НПО КОМПАС', style: darkBlue16,),
                                  )
                                ],
                              ),
